            ...
            <div className="limit-check">
                ...
                <div className="info-check">
                    ...
                    <div className="payment-check">
                        ...
                        <Input variant="flushed" id="name-card" placeholder="Subhasish Halder"/></div>
                        <div><label for="number-card" className="this-label">Credit card number</label><br />
                        <Input variant="flushed" id="number-card"  placeholder="9999-1111-7777-2222"/></div>
                        ...
                        <div className="exp-ye-cvv-check">
                            ...
                            <Input variant="flushed"  placeholder="710" id="cvv-check"/></div>
                        </div>
                        </div>
